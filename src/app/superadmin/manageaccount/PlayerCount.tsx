...
export default function PlayerCount() {
  ...
  return (
    <div className=' w-full flex flex-wrap items-center justify-center gap-4'>
        ...
        <div className={`flex items-center justify-center w-full max-w-[375px] h-full  font-normal shadow-sm rounded-xl bg-purple-400`}>
        ...
        <div className={`flex items-center justify-center w-full max-w-[375px] h-full  font-normal shadow-sm rounded-xl bg-green-400`}>
            <div className=' w-full flex flex-col gap-2 text-sm p-4'>
        ...
        <div className={`flex items-center justify-center w-full max-w-[375px] h-full  font-normal shadow-sm rounded-xl bg-sky-400`}>
            <div className=' w-full flex flex-col gap-2 text-sm p-4'>
